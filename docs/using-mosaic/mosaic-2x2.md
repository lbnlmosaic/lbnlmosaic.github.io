...
We can set tile positions with `@tile_array`. The hex files in `@pico_program` are firmware for the Pico processors. Hex files are generated based on user instructions written with C code. To see how to generate these files, [click here](/docs/hex-files)
...
<div style="display: flex; justify-content: space-between;">
  ...
  <a href="{{ '/docs/using-mosaic/tutorial' | relative_url }}" class="btn btn-light mr-2"><i class="fa-solid fa-arrow-right-long"></i> Continue</a>
</div>
