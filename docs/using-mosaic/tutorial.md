...
<div style="display: flex; justify-content: space-between;">
  <a href="{{ '/docs/using-mosaic/mosaic-2x2' | relative_url }}" class="btn btn-light mr-2"><i class="fa-solid fa-arrow-left-long"></i> Go back</a>
  <a href="{{ '/docs/using-mosaic/hex-files' | relative_url }}" class="btn btn-light mr-2"><i class="fa-solid fa-arrow-right-long"></i> Continue</a>
</div>
